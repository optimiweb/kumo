...
func Test_descendant_issue(t *testing.T) {
	// Issue #93 https://github.com/optimiweb/kumo/pkg/markupquery/xpath/issues/93
	/*
	   <div id="wrapper">
	     <span>span one</span>
	     <div>
...
func TestBUG_104(t *testing.T) {
	// BUG https://github.com/optimiweb/kumo/pkg/markupquery/xpath/issues/104
...
func TestNonEnglishPredicateExpression(t *testing.T) {
	// https://github.com/optimiweb/kumo/pkg/markupquery/xpath/issues/106
	doc := createNode("", RootNode)
