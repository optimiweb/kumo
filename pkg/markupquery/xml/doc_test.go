...
import (
	...
	"github.com/optimiweb/kumo/pkg/markupquery/xml"
	"github.com/optimiweb/kumo/pkg/markupquery/xpath"
)

func Example() {
	// XPATH syntax and functions see https://github.com/optimiweb/kumo/pkg/markupquery/xpath
	s := `<?xml version="1.0"?>
	<bookstore>
	   <book id="bk101">
