package charsetdetector_test

import (
	"github.com/optimiweb/kumo/pkg/charsetdetector"
	"io"
	"os"
	"path/filepath"
	"testing"
...
func TestDetector(t *testing.T) {
	...
	textDetector := charsetdetector.NewTextDetector()
	htmlDetector := charsetdetector.NewHtmlDetector()
